...
// DriveStatus compares a local directory with a Drive folder and reports
// four buckets (new_local, new_remote, modified, unchanged) by SHA-256 hash.
// Only Drive entries with type=file participate; online docs and shortcuts
// are skipped because there is no equivalent local binary to hash against.
var DriveStatus = common.Shortcut{
	...
	Tips: []string{
		"Only entries with type=file (binary files) are compared; online docs (docx, sheet, bitable, mindnote, slides) and shortcuts are skipped.",
		"Files present on both sides are downloaded and SHA-256 hashed to decide modified vs unchanged; expect noticeable I/O on large folders.",
	},
